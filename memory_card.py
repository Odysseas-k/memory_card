...
class TextArea():
    ...
    def set_text(self, text, fsize=12, text_color=BLACK):
        self.text = text
        self.image = pygame.sysfont.Font(None, fsize).render(text, True, text_color)
...
#create cards
quest_card = TextArea(120, 100, 500, 70, LIGHT_BLUE)
quest_card.set_text("Question", 75)
 
ans_card = TextArea(120, 240, 500, 70, LIGHT_BLUE)
